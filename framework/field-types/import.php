...
$ajax_url = html_entity_decode(wp_nonce_url('admin-ajax.php?action=woocatalog_import_settings','woocatalog_import_settings'));
...
echo "<script>
      jQuery(document).ready(function($) {
        $('#import-settings-btn').click(function() {
            if(confirm(woocatalog_msgs.import_confirm)){
