...
class Woocommerce_Catalog_Enquiry_Frontend {
    ...
    public function add_form_for_enquiry_without_popup() {
        ...
        <div id="woocommerce_catalog" name="woocommerce_catalog" >	
            ...
            <div id="responsive"  class="catalog_enquiry_form" tabindex="-1">
                ...
                <div class="modal-body">  
                    ...
                    if (isset($settings['name_label']['label']) && $settings['name_label']['label'] != '' && $settings['name_label']['label'] != ' ') {
                        echo $settings['name_label']['label'];
                    } else {
                        echo __('Enter your name : ', 'woocommerce-catalog-enquiry');
                    }
                            ?></label>	
                        <input name="woocommerce_user_name" id="woocommerce_user_name"  type="text" value="<?php echo $current_user->display_name; ?>" class="span12" />
                    </div>
                    <div class="cat-form-row">						
                        <label><?php
                    if (isset($settings['email_label']['label']) && $settings['email_label']['label'] != '' && $settings['email_label']['label'] != ' ') {
                        echo $settings['email_label']['label'];
                    } else {
                        echo __('Enter your Email Id : ', 'woocommerce-catalog-enquiry');
                    }
                            ?></label>	
                        <input name="woocommerce_user_email" id="woocommerce_user_email"  type="email" value="<?php echo $current_user->user_email; ?>" class="span12" />
                    </div>
                    <div class="cat-form-row">	
        <?php if (isset($settings['is_subject']) && $settings['is_subject'] == "Enable") { ?>
                            ...
                            ?></label>	
                            <input name="woocommerce_user_subject" id="woocommerce_user_subject"  type="text" value="<?php echo __('Enquiry about', 'woocommerce-catalog-enquiry'); ?> <?php echo $product_name; ?>" class="span12" />
                        <?php } ?>
                    </div>
                    <div class="cat-form-row">	
                        <?php if (isset($settings['form_phone']['is_enable']) && $settings['form_phone']['is_enable'] == "Enable") { ?>
                            <label><?php
                                ...
                                ?></label>	
                            <input name="woocommerce_user_phone" id="woocommerce_user_phone"  type="text" value="" class="span12" />
                        <?php } ?>
                    </div>
                    <div class="cat-form-row">	
                            ...
                            <label><?php
                                ...
                                ?></label>	
                            <input name="woocommerce_user_address" id="woocommerce_user_address"  type="text" value="" class="span12" />
                            <?php } ?>
                    </div>
                    <div class="cat-form-row">	
                    ...
                    if (isset($settings['comment_label']['label']) && $settings['comment_label']['label'] != '' && $settings['comment_label']['label'] != ' ') {
                        ...
                        echo __('Enter your Message : ', 'woocommerce-catalog-enquiry');
                                ...
                                ?></label>	
                            <textarea name="woocommerce_user_comment" id="woocommerce_user_comment"  rows="5" class="span12"></textarea>
                            <?php } ?>
                    </div>
                    <div class="cat-form-row">	
                            ...
                            <label><?php
                                    ...
                                    ?></label>	
                            <input type="file" name="woocommerce_user_fileupload" id="woocommerce_user_fileupload" class="span12" />
                    <?php } ?>
                    </div>
                    <div class="cat-form-row">							
    ...
    public function add_form_for_enquiry() {
        ...
        <?php } else { ?>
                    ...
                    <div class="modal-body">  
                        ...
                        <div class="cat-form-row">
                            <label><?php
                                if (isset($settings_gen['name_label']['label']) && $settings_gen['name_label']['label'] != '' && $settings_gen['name_label']['label'] != ' ') {
                                    echo $settings_gen['name_label']['label'];
                                } else {
                                    echo __('Enter your name : ', 'woocommerce-catalog-enquiry');
                                }
                                ?></label>	
                        ...
                        <div class="cat-form-row">
                            <label><?php
                                if (isset($settings_gen['email_label']['label']) && $settings_gen['email_label']['label'] != '' && $settings_gen['email_label']['label'] != ' ') {
                                    echo $settings_gen['email_label']['label'];
                                } else {
                                    echo __('Enter your Email Id : ', 'woocommerce-catalog-enquiry');
                                }
                                ?></label>	
