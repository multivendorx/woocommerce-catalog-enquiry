...
class Woocommerce_Catalog_Enquiry_Admin {
    ...
    public function woocommerce_catalog_enquiry_admin_footer() {
        ...
        <div id="woocommerce_catalog_admin_footer">
        <?php _e('Powered by', 'woocommerce-catalog-enquiry'); ?> <a href="http://wc-marketplace.com/" target="_blank"><img src="<?php echo $Woocommerce_Catalog_Enquiry->plugin_url . '/assets/images/dualcube.png'; ?>"></a><?php _e('WC Marketplace', 'woocommerce-catalog-enquiry'); ?> &copy; <?php echo date('Y'); ?>
        </div>
        <?php
    }
