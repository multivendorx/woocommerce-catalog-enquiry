...
class WC_Woocommerce_Catalog_Enquiry_Library {
  ...
  public function __construct() {
    ...
    $woo_catalog_options[ ] = array(
        ...
        "page_name" => __( "SeedProd", 'woocommerce-catalog-enquiry' ),
    ...
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_custom_button",
        "label" => __( "Want a custom Button?", 'woocommerce-catalog-enquiry' ),
        "desc" => __('Do you want a custom Button at the Place of add to cart button then checked here', 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
             //'required' => __( 'Make Name Required', 'woocommerce-catalog-enquiry' ),
        )
    ...
    $woo_catalog_options[ ] = array(
        ...
        "label" => __( "Hide Cart Checkout Page?", 'woocommerce-catalog-enquiry' ),
    ...
    $woo_catalog_options[ ] = array(
        "type" => "section",
        "id" => "seed_csp4_section_scripts_subs",
    ...
    $woo_catalog_options[ ] = array(
        "type" => "section",
        "id" => "seed_csp4_section_general_from",
...
*/
    ...
    $woo_catalog_options[ ] = array(
        ...
        "id" => "filesize_limit",
        "class" => "large-text",
        "label" => __( "File Upload Size Limit", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Enter File Upload size limit in MB.", 'woocommerce-catalog-enquiry' ),
    );
    /*$woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "captcha_input_label",
        "class" => "large-text",
        "label" => __( "Custom label for captcha Input", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Captcha Input.", 'woocommerce-catalog-enquiry' ),
        );
*/
    ...
    /*$woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_captcha",
        "label" => __( "Captcha Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want Captcha in for enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
        ),
    ...
    /*// Subject Field Enable ?
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_subject",
        "label" => __( "Subject Field Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want Subject field in for enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
        ),
    ...
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_phone",
        "label" => __( "Phone Field Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want Phone field in for enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( 'Disable', 'woocommerce-catalog-enquiry' ),
        ),
    ...
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_address",
        "label" => __( "Address Field Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want Address field in for enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
        ),
     
    );*/
    /*// Comment Field Enable 
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_comment",
        "label" => __( "Comment Field Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want Comment field in for enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
        ),
    ...
    $woo_catalog_options[ ] = array(
        "type" => "checkbox",
        "id" => "is_fileupload",
        "label" => __( "File Upload Field Enable ?", 'woocommerce-catalog-enquiry' ),
        "desc" => __("Do you want File Upload field in enquiry form.", 'woocommerce-catalog-enquiry'),
        "option_values" => array(
             'Enable' => __( '', 'woocommerce-catalog-enquiry' ),
        ),
   ...
   /*     $woo_catalog_options[ ] = array(
        "type" => "section",
        "id" => "seed_csp4_section_label",
        "label" => __( "Enquiry Form Label Settings", 'woocommerce-catalog-enquiry' )
    );*/
    // name_label
    /*$woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "name_label",
        "class" => "large-text",
        "label" => __( "Custom label for name", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Name.", 'woocommerce-catalog-enquiry' ),
    );
    // email_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "email_label",
        "class" => "large-text",
        "label" => __( "Custom label for email", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Email.", 'woocommerce-catalog-enquiry' ),
    );*/
    /*// subject_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "subject_label",
        "class" => "large-text",
        "label" => __( "Custom label for subject", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Subject.", 'woocommerce-catalog-enquiry' ),
    );
    // phone_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "phone_label",
        "class" => "large-text",
        "label" => __( "Custom label for phone", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Phone.", 'woocommerce-catalog-enquiry' ),
    );
    // address_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "address_label",
        "class" => "large-text",
        "label" => __( "Custom label for address", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Address.", 'woocommerce-catalog-enquiry' ),
    );
    // comment_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "comment_label",
        "class" => "large-text",
        "label" => __( "Custom label for comment", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of Comment.", 'woocommerce-catalog-enquiry' ),
    );
    // fileupload_label
    $woo_catalog_options[ ] = array(
        "type" => "textbox",
        "id" => "fileupload_label",
        "class" => "large-text",
        "label" => __( "Custom label for file upload", 'woocommerce-catalog-enquiry' ),
        "desc" => __( "Given label will shown in the frontend form field in the place of File Upload.", 'woocommerce-catalog-enquiry' ),
    );*/
    // // captcha_label
    // $woo_catalog_options[ ] = array(
    //     "type" => "textbox",
    //     "id" => "captcha_label",
    //     "class" => "large-text",
    //     "label" => __( "Custom label for captcha", 'woocommerce-catalog-enquiry' ),
    //     "desc" => __( "Given label will shown in the frontend form field in the place of Captcha.", 'woocommerce-catalog-enquiry' ),
    //     );
