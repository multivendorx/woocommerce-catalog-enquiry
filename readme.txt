...
* Enquiry Dashboard - Admin will have a list of all enquiries and may take necessary action as per requirement.
...
If you have WC Marketplace installed, then use <strong>Vendor can</strong>

* Choose vendor specific email template.
* Vendor can allow product selling for specific OWN products. Other products will be shown in the catalog.
* Vendor can exclude their products from the enquiry.
...
== 3.2.2 =
* Added: When remove price button is checked then sort by price will be hide.
* Added: add extra exclusion setting based on user role.
* Added: Exclustion lists are in new format.
* Added: new option on button setting to put button in anywhere in a single product page.
* Fixed: Multiple mail send to admin on multiple time button click.
* Fixed: Rest API critical issue fixed on site helth
